...
app.post('/place_order',function(req,res){
    ...
    con.connect(function(err){
        if(err){
            ...
            var query="INSERT INTO orders(cost,name,email,status,city,adresse,phone,date,products_ids) VALUES ?";
            var values = [
                [cost,name,email,status,city,adresse,phone,date,products_ids]
            ];
